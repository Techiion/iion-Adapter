...
public class IionCustomBanner extends BaseBanner<IionCustomAdapter> {
    public static final String TAG = "IionCustomBanner";

    IionCustomAdapter iionCustomAdapter = getNetworkAdapter();
    private AlxBannerView mBannerView;
    private BannerAdListener mListener;

    public IionCustomBanner(NetworkSettings networkSettings) {

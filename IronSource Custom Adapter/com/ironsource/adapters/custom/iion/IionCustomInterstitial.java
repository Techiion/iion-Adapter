...
public class IionCustomInterstitial extends BaseInterstitial<IionCustomAdapter> {

    private static final String TAG = "IionCustomInterstitial";
    private AlxInterstitialAD alxInterstitialAD;
    private String unitid = "";
    IionCustomAdapter iionCustomAdapter = getNetworkAdapter();
    InterstitialAdListener mInterstitialAdListener;
    private Context mContext;

    public IionCustomInterstitial(NetworkSettings networkSettings) {
    ...
    public void loadAd(final AdData adData, Activity activity, InterstitialAdListener interstitialAdListener) {
        ...
        try {
            ...
            iionCustomAdapter.init(adData, activity, new NetworkInitializationListener() {
                @Override

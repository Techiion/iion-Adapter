...
//            }
                ...
                public void run() {
                    ...
                    AppLovinSdkUtils.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            MaxNativeAd maxNativeAd = new MaxIionNativeAd(maxBuilder);
    ...
    private class MaxIionNativeAd extends MaxNativeAd {
        ...
        public MaxIionNativeAd(Builder builder) {
            super(builder);
        }

        @Override
        public void prepareViewForInteraction(final MaxNativeAdView maxNativeAdView) {
            final AlxNativeAd nativeAD = IionMediationAdapter.this.nativeAD;
            if (nativeAD == null) {
